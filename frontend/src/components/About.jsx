      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          ...
          <p className='my-10 max-w-lg'>
            Estate is committed to delivering high-quality real estate projects that meet modern standards 
            in design, sustainability, and functionality. With a strong focus on transparency, timely delivery, 
          ...
          {showMore && (
            <div className='text-gray-700 bg-gray-100 p-5 rounded-lg shadow-md w-full max-w-lg'>
